...
su.controller('projectFeedController', function projectFeedController($scope, $http, $uibModal) {
    ...
    $http.get("/data/projects").success(function(data, status) {
        $scope.projects = $sce.trustAsHtml(data);
        console.log(data);
    });
...
su.controller('myProjectFeedController', function myProjectFeedController($scope, $http, $uibModal) {
     ...
     * Get Questions on Page Load
     */
    $http.get("/data/myprojects").success(function(data, status) {
        $scope.projects = data;
        console.log(data);
    });
