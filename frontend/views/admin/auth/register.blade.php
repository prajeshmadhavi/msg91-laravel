        ...
        <div class="card-body landing-page p-t-25">
            ...
            <div class="tab-content p-20 landing-page">
                ...
                <div role="tabpanel" class="tab-pane animated fadeIn in active" id="tab-1">
                    <form method="post" action="{!! url('backoffice/register') !!}">
                        <div class="form-group">
                            <input type="text" name="name" class="custom_form-control" placeholder="Name">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="password" class="custom_form-control" placeholder="Confirm Password" name="password_confirmation">
                        </div>
                        <div class="form-group landing-page">
                            <button type="submit" class="btn landing-page waves-effect">Register</button>
                        </div>
