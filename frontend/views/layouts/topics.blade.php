...
@section('body')
    ...
    <div class="scrollable">
        <div class="content_scroable-wrapper">
            ...
            <div class="tab-pane fade active in" id="toggle-home"  ng-controller="topicFeedController" >
                <div class="col-md-12 col-lg-12 col-sm-12 no-padding">

                    <!-- TOPIC UPDATES-->

                    <div class="card col-lg-3 col-md-3 col-sm-3 added no-padding grid_card" ng-repeat="index in topics" ng-click="showTopicModal(index.topic)" ng-if="topics.length > 0" ng-cloak>
                        ...
                        <div class="grid_footer-info">
                            <div>
                                <ul class="cancel_factory">
                                    ...
                                    <li><small>@{{ index.topic.time }}</small></li>
