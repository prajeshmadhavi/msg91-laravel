        ...
        <div class="container no-padding">
                            ...
                            <ul class="banner__user--info cancel_factory">
                                ...
                                <li>
                                    <ul class="cancel_factory banner_info-text">
                                        <li class="gray">
                                            <a data-toggle="modal" href="#modal-subject"> 
                                                ADD SUBJECTS
                                            </a>
                                        </li>
                                    </ul>
            ...
            <div class="padding-top">
                <div class="col-lg-3 col-md-3 col-sm-3 hidden-xs p-10 n-p-t adjusted_marginleft-10">
                    <div class="col-lg-12 p-10 tab_toggle" style="background-color: white; border-radius: 5px;">
                        <ul class="cancel_factory">
                            <li class="gray p-10 active "><a href="#tab-subjects" data-toggle="tab" aria-expanded="true">university subjects</a></li>
                            <li class="gray p-10 "><a href="#tab-onlinesubjects" data-toggle="tab" aria-expanded="false">online subjects</a></li>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active in" id="tab-subjects">
                                ...
                                @foreach($subjects as $subject)
                                    ...
                                    <div class="card col-lg-4 col-md-4 col-sm-6 adjusted__width--custom no-padding grid_card">
                                        ...
                                        <div class="grid_head-info">
                                            <div><img src="{!! $subject->faculty(university()->id)->avatar !!}" class="lv-img feed_image" alt=""></div>
                                            <div>
                                                <ul class="cancel_factory pl-10">
                                                    <li>{!! $subject->faculty(university()->id)->name !!}</li>
                                        ...
                                        <div class="grid_image-holder">
                                            <a href="/university/subject_details?subject={!! $subject->id !!}&department=n&faculty={!! $subject->faculty(university()->id)->id !!}" class="c-black">
                                        ...
                                        <div class="grid_footer-info">
                                            <div>
                                                <ul class="cancel_factory">
                                                    <li>{!! $subject->name !!}</li>
                                                    <li><small>{!! enrolled($subject) !!}  Enrolled</small></li>
                                                </ul>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-pane fade" id="tab-onlinesubjects">
                            ...
                            <div class="mm-top">
                                ...
                                @foreach($courses as $course)
                                    ...
                                    <div class="card col-lg-4 col-md-4 col-sm-6 adjusted__width--custom no-padding grid_card">
                                        ...
                                        <div class="grid_image-holder">
                                            <a href="/university/course_details/{!! $course->id !!}?course={!! $course->id !!}&department=n" class="c-black">
                                                <img src="../assets/img/profile-menu.png" alt="" class="grid_image-cover">
                                            </a>
                                        </div>
                                        <div class="grid_footer-info">
                                            <div>
                                                <ul class="cancel_factory">
                                                    {{--<li>{!! $subject->name !!}</li>--}}
                                                    <li><small>{!! $course->enrolled->count() !!}  Enrolled</small></li>
                                                </ul>
                                            </div>
                                        </div>
