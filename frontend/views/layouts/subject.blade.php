                        ...
                        <div class="tab-pane fade active in" id="toggle-subject">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade active in" id="tab-this">
                                    ...
                                    <div class="tab-content">
                                        <!--------------------UPDATES-------------------->
                                        <div class="tab-pane fade active in" data-toggle="tab" id="toggle-sub_updates" ng-controller="subjectUpdateController">
                                        ...
                                        <!-------------------------LECTURES-------------------------------->
                                        <div class="tab-pane fade" id="toggle-sub_lectures">
                                            <div class="col-lg-12 col-md-12 col-sm-12 p-t-20 bground">
                                                @if(is_faculty())
                                                    <div class="card col-lg-3 col-md-3 col-sm-3 added2 first no-padding grid_card">
                                                        <div class="" data-toggle="modal" href="#modal-addlectures">
                                                            <i class="zmdi zmdi-plus-circle-o enlage"></i>
                                                            <span class="text-muted">ADD LECTURE</span>
                                                        </div>
                                                        <div class="grid_head-info">
                                                            <div class="feed_user_info">
                                                                <ul class="cancel_factory pl-10">
                                                                    <li class="f-15"><a ></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="card col-lg-3 col-md-3 col-sm-3 added2 no-padding grid_card">
                                                    <div class="grid_image-holder">
                                                        <a target="_self" href="/subject_lectures?lecture={!! $lecture->id !!}&subject={!! $subject->id !!}&department=n&faculty={!!  $subject->faculty(university()->id)->id !!}" class="img_link">
                                                    ...
                                                    <div class="grid_head-info">
                                                        <div class="feed_user_info">
                                                            <ul class="cancel_factory pl-10">
                                                                <li class="f-15">{!! $lecture->id .'. '. $lecture->name !!}</li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
