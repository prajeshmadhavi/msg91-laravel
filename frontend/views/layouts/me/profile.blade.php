                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade active in" id="tab-this">
                                    <div class="top_banner pro">
                                        ...
                                        <div class="col-sm-3 col-md-3 col-lg-3 pull-right p-t-10" ng-controller="followStudentProfileController">
                                            @if(is_student() && $member->id != user()->id)
                                                <button class="btn btn-primary follow" id="student_follow_button" ng-click="follow_unfollow()">Follow</button>
                                            @endif
                                        ...
                                        <div class="col-sm-12 col-md-12 p-0 text-center text-uppercase">
                                            ...
                                            <ul class="p-l-10">
                                                <li>
                                                    <a href="#toggle-sub_followers" data-toggle="tab" aria-expanded="true">
                                                        FOLLOWERS<span class="text-muted">  {!! count($member->getFollowers()) !!}</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#toggle-sub_following" data-toggle="tab" aria-expanded="true">
                                                        FOLLOWING<span class="text-muted">  {!! count($member->getFollowing()) !!}</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <ul class="tab-nav in p-l-10">
                                                <li class="active">
                                                    <a href="#toggle-sub_updates" data-toggle="tab" aria-expanded="false">
                                                        UPDATES <span class="text-muted">{!! count($member->posts()) !!}</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="#toggle-sub_files" data-toggle="tab" aria-expanded="true">
                                                        FILES <span class="text-muted">{!! count($member->notes) !!}</span>
                                                    </a>
                                                </li>
                                                <!--<li class="">
                                                ...
                                                <li>
                                                    <a href="#toggle-sub_projects" data-toggle="tab" aria-expanded="false">
                                                        PROJECTS<span class="text-muted">{!! count($member->project) !!}</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#toggle-sub_questions" data-toggle="tab" aria-expanded="false">
                                                        QUESTIONS<span class="text-muted">{!! count($member->topics) !!}</span>
                                                    </a>
                                                </li>
                                                <li>
