                    ...
                    <div class="userinfo__content--holder">
                        <div class="leftside__content">
                            <ul class="banner__user--info cancel_factory">
                                <li class="banner__img--holder"> <img src="../assets/img/shawaz.jpg" alt="" class="jumbotron_profile--img"></li>
                                <li>
                                    <ul class="cancel_factory banner_info-text">
                                        <li>{!! $member->name !!}</li>
                                        @if(count($member->department) > 1)
                                            @foreach($member->department as $key => $value)
                                                <li class="gray">{!! $member->department[$key]->name !!}</li>
                                            @endforeach
                                        @else
                                            <li class="gray">{!! $member->department->first()->name !!}</li>
                                        @endif
                                        <li class="username-highlighted">{!! $member->university->name !!}</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <div class="rightside__content">
                            ...
                            <span class="follow_counter">{!! count($member->student) !!} ENROLLED</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card col-lg-3 col-md-3 col-sm-3 hidden-xs right-bar su lefthandedbar">
                    <div class="col-lg-12 assignment_panel2">
                        <div class="listview left-side-bar">
                            <!-- <div class="card-header su sidemenu-mini">
                                <div class="media">
                                    <div class="pull-left">
                                        <img class="lv-img feed_image left_bar-menu" src="../assets/img/shawaz.jpg" alt="">
                                    </div>

                                    <div class="media-body m-t-5">
                                        <div class="pull-left">
                                            <ul class="info_aligner">
                                                <li class="username-highlighted left_bar-menu">{!! $member->university->name !!}</li>
                                                <li><small>{!! $member->university->address !!}</small></li>
                                                <li class="time_notify"><img src="../assets/img/icon-set-png/high-school.png"class="su_icon notify" alt=""></li>
                                            </ul>
                            ...
                            <div class="lv-body left-side-bar">
                                <ul class="left_side-listmenu">
                                    <li href="#subject-updates" data-toggle="tab" aria-expanded="true" class="left_side-listmenu-item">
                                        <table class="left_side-listmenu-table">
                                            <tr class="menu_item-row">
                                                <td class="menu_icon-holder"><img src="../assets/img/icon-set-png/atom.png" class="su_icon" alt=""></td>
                                    ...
                                    <li href="#subject-lectures" data-toggle="tab" aria-expanded="false" class="left_side-listmenu-item">
                                        <table class="left_side-listmenu-table">
                                            <tr class="menu_item-row">
                                                <td class="menu_icon-holder"><img src="../assets/img/icon-set-png/blackboard.png" class="su_icon" alt=""></td>
                                    ...
                                    <li href="#subject-reports" data-toggle="tab" aria-expanded="false" class="left_side-listmenu-item">
                                        <table class="left_side-listmenu-table">
                                            <tr class="menu_item-row">
                                                <td class="menu_icon-holder"><img src="../assets/img/icon-set-png/newspaper.png" class="su_icon" alt=""></td>
                                    ...
                                    <li href="#subject-members" data-toggle="tab" aria-expanded="false" class="left_side-listmenu-item">
                                        <table class="left_side-listmenu-table">
                                            <tr class="menu_item-row">
                                                <td class="menu_icon-holder"><img src="../assets/img/icon-set-png/graduate.png" class="su_icon" alt=""></td>
                                ...
                                <div role="tabpanel" class="tab-pane " id="newsfeed-tab">
                                    <div class="card">
                                        <div class="card-header su">
                                            <div class="media">
                                                <div class="pull-left">
                                                    <img class="lv-img feed_image" src="../assets/img/profile-pics/1.jpg" alt="">
                                                </div>
                                                        ...
                                                        <div class=" animated fadeIn">
                                                            ...
                                                            <div role="tabpanel" class="tab-pane" id="subject-lectures">
                                                                ...
                                                                <div class=" animated fadeIn">
                                                                    ...
                                                                    @foreach($member->subject as $all_subjects)

                                                                        @foreach($all_subjects->lectures as $lecture)
                                                                                        ...
                                                                                        <div class="card-body card-padding">
                                                                                            ...
                                                                                            <div class="feeds-uploaded-images">
                                                                                                <div class="wall-img-preview lightbox clearfix">
                                                                                                    <div class="wip-item" data-src="../assets/media/gallery/2.jpg" style="background-image: url(../assets/media/gallery/2.jpg);">
                                                                                                        <img src="../assets/media/gallery/thumbs/2.jpg">
                                                                                                    </div>
                                                                                                </div>
                                                                                            ...
                                                                                            <div class="wcl-list comments_list">
                                                                                                <div class="media">
                                                                                                    ...
                                                                                                    <div class="media-body">
                                                                                                        ...
                                                                                                        <p class="m-t-5 m-b-0 commented_contents">Pellentesque mollis fringilla finibus. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</p>
                                                                                                    </div>
                                                                            ...
                                                                            <div class="listview">
                                                                                <div class="lv-body">
                                                                                    ...
                                                                                    <a class="lv-item" href="">
                                                                                        <div class="media">
                                                                                            <div class="pull-left">
                                                                                                <img class="lv-img-sm left_bar-menu" src="../assets/img/icon-set-png/desk-lamp.png" alt="">
                                                                                            </div>
                                                                            ...
                                                                            <div class="listview">
                                                                                <div class="lv-body">
                                                                                 ...
                                                                                 @if($member->attendance->count() > 0)
                                                                                    ...
                                                                                    @foreach($member->attendance as $key => $value)
                                                                            ...
                                                                            <div class="listview">
                                                                                <div class="lv-body">
                                                                                    ...
                                                                                    <a class="lv-item" href="">
                                                                                        <div class="media">
                                                                                            <div class="pull-left">
                                                                                                <img class="lv-img-sm left_bar-menu" src="../assets/img/icon-set-png/grades.png" alt="">
                                                                                            </div>
                                                        ...
                                                        <div class="card animated fadeIn m-b-10">
                                                            <div class="card-header su">
                                                                <div class="media-body m-t-5 p-5">
                                                                    <img src="../assets/img/icon-set-png/mortarboard.png" alt="" class="su_icon p-b-5 p-t-5 f-700">
                                                                    <span class="p-l-10">INSTRUCTOR</span>
                                                                    <div class="p-t-5">
                                                                        <img class="lv-img" src="../assets/img/shawaz.jpg" alt="">
                                                                        <span class="p-l-5 p-t-10">{!! $member->name !!}</span>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="panel-group" role="tablist" aria-multiselectable="true">
                                                                        <div class="panel panel-collapse m-0    ">
                                                                            <div class="panel-heading" role="tab" id="headingOne">
                                                                                <img class="lv-img-sm pull-left p-t-5 m-r-10" src="../assets/img/icon-set-png/graduate.png" alt="">
                                                                                <h4 class="panel-title">
                                                                                    <a data-toggle="collapse" class="p-15 m-t-5" data-parent="#accordion" href="#student-1" aria-expanded="false" aria-controls="collapseOne">
                                                                                        STUDENTS
                                                                                    </a>
                                                                                </h4>
                                                                            </div><hr class="m-0">
                                                                                ...
                                                                                <div class="panel-body text-justify">
                                                                                   ...
                                                                                   @if(count($students) > 0)
                                                                                     @foreach($students as $value)
                                                                                        <div class="p-t-5">
                                                                                            <img class="lv-img-sm" src="../assets/img/shawaz.jpg" alt="">
                                                                                            <span class="p-l-15 p-t-10">{!! $value->name!!}</span>
                                                                                        </div>
                                                                                     @endforeach
                                                                                   @endif
                                                                    ...
                                                                    <div class="panel-group" role="tablist" aria-multiselectable="true">
                                                                        <div class="panel panel-collapse m-0    ">
                                                                            <div class="panel-heading" role="tab" id="headingtwo">
                                                                                <img class="lv-img-sm pull-left p-t-5 m-r-10" src="../assets/img/icon-set-png/graduate.png" alt="">
                                                                                <h4 class="panel-title">
                                                                                    <a data-toggle="collapse" class="p-15 m-t-5" data-parent="#accordion" href="#certified-1" aria-expanded="true" aria-controls="collapseOne">
                                                                                        CERTIFIED
                                                                                    </a>
                                                                                </h4>
                                                                            </div><hr class="m-0">
                                                    ...
                                                    <div role="tabpanel animated fadeInRight" class="tab-pane active" id="department-updates">
                                                        <div class="card animated fadeInRight">
                                                            <div class="card-header su">
                                                                <div class="media">
                                                                    <div class="pull-left">
                                                                        <img class="lv-img" src="../assets/img/profile-pics/1.jpg" alt="">
                                                                    </div>
                    ...
                    <div class="card result col-lg-12 c-overflow">
                        <div class="listview">
                            ...
                            <span class="lv-item su" href="">
                                <div class="media">
                                    <div class="pull-left">
                                        <img class="lv-img-sm su_icon" src="../assets/img/icon-set-png/screen.png" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <span class="lv-item su" href="">
                                <div class="media">
                                    <div class="pull-left">
                                        <img class="lv-img-sm su_icon" src="../assets/img/icon-set-png/hands.png" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <span class="lv-item su" href="">
                                <div class="media">
                                    <div class="pull-left">
                                        <img class="lv-img-sm su_icon" src="../assets/img/icon-set-png/newspaper.png" alt="">
                                    </div>
                                    <div class="media-body">
                            ...
                            <span class="lv-item su" href="">
                                <div class="media">
                                    <div class="pull-left">
                                        <img class="lv-img-sm su_icon" src="../assets/img/icon-set-png/notebook.png" alt="">
                                    </div>
                                    <div class="media-body">
